...
export const testAttributeModificationsYToDom = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
...
export const testElementInsertYToDom = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
...
export const testInsertThenDeleteYToDom = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
...
export const testDeleteConsecutive1OnText = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
...
export const testDeleteConsecutive2OnText = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
  xml0.insert(0, [new Y.XmlText('1'), new Y.XmlText('2'), new Y.XmlText('3')])
  xml0.delete(0, 1)
  xml0.delete(1, 1)
...
export const testDeleteConsecutive1OnElement = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
...
export const testDeleteConsecutive2OnElement = tc => {
  const { users, xml0, dom0 } = init(tc, { users: 3 })
  xml0.insert(0, [new Y.XmlElement('A'), new Y.XmlElement('B'), new Y.XmlElement('C')])
  xml0.delete(0, 1)
  xml0.delete(1, 1)
...
export const testRetriveABunchOfElementsWithDisconnect = tc => {
  const { testConnector, users, xml0, xml1, dom0, dom1 } = init(tc, { users: 3 })
  users[1].disconnect()
  xml0.insert(0, [new Y.XmlElement('A'), new Y.XmlElement('B'), new Y.XmlElement('C')])
