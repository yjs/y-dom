    ...
    this.type._y.transact(() => {
      ...
      mutations.forEach(mutation => {
        ...
        if (yxml === undefined) { // In case yxml is undefined, we double check if we forgot to bind the dom
          ...
          if (yParent !== false && yParent !== undefined && yParent.constructor !== Y.XmlHook) {
        ...
        switch (mutation.type) {
          case 'characterData':
            ...
            break
          case 'attributes':
            if (yxml.constructor === Y.XmlFragment) {
              break
            }
            ...
            if (yxml.constructor !== Y.XmlFragment && this.filter(dom.nodeName, attributes).size > 0) {
